...
impl CppLanguageLevel {
    ...
    pub fn supports_feature(&self, feature: CppFeature) -> bool {
        ...
        match feature {
            ...
            // C++11 features
            Auto | Lambda | RValueReferences | SmartPointers | VariadicTemplates
            | ThreadSupport | RegexSupport | RandomNumbers | TimeUtilities => {
                *self >= CppLanguageLevel::Cpp11
            }

            // C++14 features
            GenericLambda | VariableTemplates | BinaryLiterals | DigitSeparators => {
                *self >= CppLanguageLevel::Cpp14
            }
            ...
            | FoldExpressions
            | InlineVariables => *self >= CppLanguageLevel::Cpp17,
            ...
            | Ranges
            | ThreeWayComparison
            | DesignatedInitializers => *self >= CppLanguageLevel::Cpp20,

            // C++23 features
            DeducingThis | IfConsteval | MultidimensionalSubscript => {
                *self >= CppLanguageLevel::Cpp23
            }
