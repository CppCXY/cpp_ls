...
//         if self.current_token == CppTokenKind::TkEof {
//             return;
//         }
...
//                 while matches!(self.current_token, CppTokenKind::TkWhitespace) {
//                     self.eat_current_and_lex_next();
//                 }
//             }
...
//                 while matches!(
//                     self.current_token,
//                     CppTokenKind::TkEndOfLine | CppTokenKind::TkWhitespace
//                 ) {
//                     self.eat_current_and_lex_next();
//                 }
//             }
...
//         let mut kind = CppTokenKind::TkEof;
//         loop {
//             if self.lexer.is_invalid() {
//                 let next_origin_index =
//                     if self.origin_token_index == 0 && self.current_token == CppTokenKind::None {
//                         0
//                     } else {
//                         self.origin_token_index + 1
//                     };
//                 if next_origin_index >= self.tokens.len() {
//                     return LuaTokenData::new(CppTokenKind::TkEof, SourceRange::EMPTY);
//                 }

//                 let next_origin_token = self.tokens[next_origin_index];
//                 self.origin_token_index = next_origin_index;
//                 if next_origin_token.kind == CppTokenKind::TkEndOfLine
//                     || next_origin_token.kind == CppTokenKind::TkWhitespace
//                     || next_origin_token.kind == CppTokenKind::TkShebang
//                 {
...
//                         | CppTokenKind::TkDocContinueOr
//                 ) {
//                     self.current_token = CppTokenKind::TkDocTrivia;
//                 }
//             }
//             _ => {}
//         }
...
//         self.current_token = CppTokenKind::TkDocDetail;
//         if self.lexer.is_invalid() {
//             return;
//         }
//         self.current_token = CppTokenKind::None;
...
//     match kind {
//         CppTokenKind::None | CppTokenKind::TkEof => true,
//         _ => false,
//     }
// }
